...
//                  Feb 27, 2020
//                  By Professor (all rights reserved)
...
// class something : public ECObserver{
// public:
//     something(ECTextViewImp *p){
//         pp = p;
//         num = 0;
//         line = "";
//         edits.push_back("");
...
//             if(pp->GetCursorX() != (edits[pp->GetCursorY()].size())){
//                 std::string part1 = "";
//                 std::string part2 = "";
//                 for(int x = 0; x < pp->GetCursorX(); x++){
//                     part1 += edits[pp->GetCursorY()][x];
//                 }
//                 for(int x = pp->GetCursorX(); x < edits[pp->GetCursorY()].size(); x++){
//                     part2 += edits[pp->GetCursorY()][x];
//                 }

//                 edits[pp->GetCursorY()] = part1;
//                 edits.insert(edits.begin() + (pp->GetCursorY() + 1), part2);

//                 pp->InitRows();
//                 for(int b = 0; b < edits.size(); b++){
//                 pp->AddRow(edits[b]);
//                 }
//             }
//             else{
...
//         }
//         else if(pp->GetPressedKey() == ARROW_LEFT){
//             if(pp->GetCursorX() > 0)
//                 pp->SetCursorX(pp->GetCursorX() - 1);
//         }
//         else if(pp->GetPressedKey() == ARROW_UP){
//             if(pp->GetCursorY() > 0){
//                 pp->SetCursorY(pp->GetCursorY() - 1);
//             }
//         }
//         else if(pp->GetPressedKey() == ARROW_DOWN){
//             if(pp->GetCursorY() < num){
//                 pp->SetCursorY(pp->GetCursorY() + 1);
//             }
//         }
//         else{
